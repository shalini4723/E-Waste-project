...
import { useCreateBookingMutation, useGetAddressesQuery, useGetlaptopModelsByBrandQuery, useGetlaptopBrandsQuery, useGetModelsByBrandQuery, useGetAccessoriesBrandsQuery, useGetAccessoriesModelsByBrandQuery } from "../../../server/APIs";
...
const Accessories: React.FC = () => {
    ...
    const { data: brands, isLoading } = useGetAccessoriesBrandsQuery();
    const [selectedBrand, setSelectedBrand] = useState<string>("");

    const { data: models } = useGetAccessoriesModelsByBrandQuery(selectedBrand, {
        skip: !selectedBrand,
    });
