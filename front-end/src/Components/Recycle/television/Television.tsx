...
import { useCreateBookingMutation, useGetAddressesQuery, useGetlaptopModelsByBrandQuery, useGetlaptopBrandsQuery, useGetModelsByBrandQuery, useGetAccessoriesBrandsQuery, useGetAccessoriesModelsByBrandQuery, useGetTelevisionBrandsQuery, useGetTelevisionModelsByBrandQuery } from "../../../server/APIs";
...
const Television: React.FC = () => {
    ...
    const { data: brands, isLoading } = useGetTelevisionBrandsQuery();
    const [selectedBrand, setSelectedBrand] = useState<string>("");

    const { data: models } = useGetTelevisionModelsByBrandQuery(selectedBrand, {
        skip: !selectedBrand,
    });
