...
import './Laptop.css';
import { useCreateBookingMutation, useGetAddressesQuery, useGetlaptopModelsByBrandQuery, useGetlaptopBrandsQuery, useGetModelsByBrandQuery } from "../../../server/APIs";
...
const Laptop: React.FC = () => {
    ...
    const { data: brands, isLoading } = useGetlaptopBrandsQuery();
    const [selectedBrand, setSelectedBrand] = useState<string>("");
    const { data: models } = useGetlaptopModelsByBrandQuery(selectedBrand, {
        skip: !selectedBrand,
    });
